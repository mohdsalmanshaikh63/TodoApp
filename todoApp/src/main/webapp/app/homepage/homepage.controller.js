...
// home controller which will be same for all views of homepage
angular.module('homepage')
    .controller('homepageController', ['$scope', 'homepageService', '$state',
        function ($scope, homepageService, $state) {
